...
<section class="container max-w-6xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <p class="text-lg">Give your code style a boost with Duster. <br class="hidden sm:block">Generate elegant, oraganized code quickly and easily.</p>

            <div class="flex my-10 bg-gray-300 p-2 rounded font-semibold justify-center">
                <span class="text-gray-500 mr-2">$</span> composer require tightenco/duster --dev
            </div>
        </div>
